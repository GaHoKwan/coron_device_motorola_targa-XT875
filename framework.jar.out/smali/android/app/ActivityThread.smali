...
.field mPendingCompatInfo:Landroid/content/res/CompatibilityInfo;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/app/ActivityThread;->DEBUG_6PA_KPI:Z
...
.method constructor <init>()V
    ...
    .line 229
    iput-object v1, p0, Landroid/app/ActivityThread;->mPendingCompatInfo:Landroid/content/res/CompatibilityInfo;
...
.method static synthetic access$200()Z
    ...
    .prologue
    .line 141
    sget-boolean v0, Landroid/app/ActivityThread;->DEBUG_6PA_KPI:Z
...
.method static synthetic access$3100(Landroid/app/ActivityThread;Landroid/app/LoadedApk;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private handleLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)V
    ...
    .line 2147
    sget-boolean v3, Landroid/app/ActivityThread;->DEBUG_6PA_KPI:Z

    if-eqz v3, :cond_0

    .line 2148
    const-string v3, "KPI-6PA-AT-5"
    ...
    const-string v5, " enter ApplicationThread.handleLaunchActivity()"
    ...
    invoke-virtual {p0, v3, v7, v4}, Landroid/app/ActivityThread;->handleResumeActivity(Landroid/os/IBinder;ZZ)V
    ...
    const-string v5, " leave ApplicationThread.handleLaunchActivity()"
...
.method private handlePauseActivity(Landroid/os/IBinder;ZZI)V
    ...
    .line 2917
    sget-boolean v1, Landroid/app/ActivityThread;->DEBUG_6PA_KPI:Z

    if-eqz v1, :cond_0

    .line 2918
    const-string v1, "KPI-6PA-AT-2"
    ...
    const-string v3, " enter ActivityThread.handlePauseActivity()"
...
.method private handleRelaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    .line 3694
    sget-boolean v7, Landroid/util/DisplayMetrics;->IS_WEBTOP_ENABLED:Z
    ...
    .line 3696
    :try_start_1
    iget-object v7, v5, Landroid/app/ActivityThread$ActivityClientRecord;->compatInfo:Landroid/content/res/CompatibilityInfo;

    iget-object v9, p0, Landroid/app/ActivityThread;->mPendingCompatInfo:Landroid/content/res/CompatibilityInfo;

    invoke-direct {p0, v7, v9}, Landroid/app/ActivityThread;->isWebtopModeChanged(Landroid/content/res/CompatibilityInfo;Landroid/content/res/CompatibilityInfo;)Z
    ...
    const-string v9, "Abort, activity not relaunching due to webtop/phone mode change is ongoing"
...
.method private handleUpdatePackageCompatibilityInfo(Landroid/app/ActivityThread$UpdateCompatibilityData;)V
    ...
    .line 3299
    :cond_1
    iget-object v1, p1, Landroid/app/ActivityThread$UpdateCompatibilityData;->config:Landroid/content/res/Configuration;
...
.method private installProvider(Landroid/content/Context;Landroid/app/IActivityManager$ContentProviderHolder;Landroid/content/pm/ProviderInfo;ZZZ)Landroid/app/IActivityManager$ContentProviderHolder;
    ...
    invoke-direct {v0, v2}, Landroid/app/ActivityThread;->scheduleMakeApplication(Landroid/content/pm/ApplicationInfo;)V
    :try_end_0
...
.method private isWebtopModeChanged(Landroid/content/res/CompatibilityInfo;Landroid/content/res/CompatibilityInfo;)Z
    .locals 3
    .parameter "oldInfo"
    .parameter "newInfo"
    ...
    invoke-virtual {p1}, Landroid/content/res/CompatibilityInfo;->needsWebtopCompat()Z

    move-result v1

    invoke-virtual {p2}, Landroid/content/res/CompatibilityInfo;->needsWebtopCompat()Z
...
.method public static main([Ljava/lang/String;)V
    ...
    const-string v3, " enter ActivityThread.main()"
    ...
    invoke-direct {v0, v5}, Landroid/app/ActivityThread;->attach(Z)V
...
.method final applyConfigurationToResourcesLocked(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Z
    ...
    .line 3848
    iget-object v8, p0, Landroid/app/ActivityThread;->mResConfiguration:Landroid/content/res/Configuration;
    ...
    iput-object v8, p0, Landroid/app/ActivityThread;->mResConfiguration:Landroid/content/res/Configuration;
    ...
    .line 3858
    :cond_1
    sget-boolean v8, Landroid/util/DisplayMetrics;->IS_WEBTOP_ENABLED:Z
    ...
    iget v9, p1, Landroid/content/res/Configuration;->screenLayout:I

    invoke-virtual {v8, v9}, Lcom/motorola/webtop/WebtopMode;->update(I)V
    ...
    invoke-virtual {p0, v8, v6}, Landroid/app/ActivityThread;->getDisplayMetricsLocked(Landroid/content/res/CompatibilityInfo;Z)Landroid/util/DisplayMetrics;
    ...
    iget-object v8, p0, Landroid/app/ActivityThread;->mResCompatibilityInfo:Landroid/content/res/CompatibilityInfo;

    if-eqz v8, :cond_3

    iget-object v8, p0, Landroid/app/ActivityThread;->mResCompatibilityInfo:Landroid/content/res/CompatibilityInfo;

    invoke-virtual {v8, p2}, Landroid/content/res/CompatibilityInfo;->equals(Ljava/lang/Object;)Z
    ...
    .line 3877
    .local v4, tempMetrics:Landroid/util/DisplayMetrics;
    invoke-virtual {v4, v1}, Landroid/util/DisplayMetrics;->setTo(Landroid/util/DisplayMetrics;)V
    ...
    invoke-virtual {v8, v4}, Landroid/content/res/CompatibilityInfo;->applyToDisplayMetrics(Landroid/util/DisplayMetrics;)V

    .line 3881
    :cond_5
    iget v8, v4, Landroid/util/DisplayMetrics;->densityDpi:I

    invoke-static {v8}, Landroid/graphics/Bitmap;->setDefaultDensity(I)V

    .line 3889
    .end local v4           #tempMetrics:Landroid/util/DisplayMetrics;
    :cond_6
    ...
    .line 3904
    .local v5, v:Ljava/lang/ref/WeakReference;,"Ljava/lang/ref/WeakReference<Landroid/content/res/Resources;>;"
    ...
    .end local v5           #v:Ljava/lang/ref/WeakReference;,"Ljava/lang/ref/WeakReference<Landroid/content/res/Resources;>;"
    :cond_9
    if-eqz v0, :cond_a
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    .line 3953
    :cond_1
    iget-object v4, p0, Landroid/app/ActivityThread;->mPendingCompatInfo:Landroid/content/res/CompatibilityInfo;

    if-eqz v4, :cond_2

    .line 3954
    iget-object p2, p0, Landroid/app/ActivityThread;->mPendingCompatInfo:Landroid/content/res/CompatibilityInfo;

    .line 3955
    const/4 v4, 0x0

    iput-object v4, p0, Landroid/app/ActivityThread;->mPendingCompatInfo:Landroid/content/res/CompatibilityInfo;
