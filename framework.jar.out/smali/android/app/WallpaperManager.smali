...
.method public suggestDesiredDimensions(II)V
    ...
    .line 675
    :cond_0
    const-string/jumbo v1, "persist.sys.texturesize.max"
...
.method public suggestDesiredDimensionsForWebtop(II)V
    .locals 6
    .parameter "minimumWidth"
    .parameter "minimumHeight"
    ...
    invoke-interface {v3, v2}, Landroid/view/IWindowManager;->getRealDisplaySize(Landroid/graphics/Point;)V
    ...
    .line 711
    .local v1, minDim:I
    invoke-interface {v3}, Landroid/view/IWindowManager;->isWebtopMode()Z
    ...
    .line 718
    :cond_0
    const-string/jumbo v4, "persist.sys.texturesize.max"
    ...
    invoke-interface {v4, p1, p2}, Landroid/app/IWallpaperManager;->setDimensionHints(II)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    .line 729
    .end local v0           #maxTextureSize:I
    .end local v1           #minDim:I
