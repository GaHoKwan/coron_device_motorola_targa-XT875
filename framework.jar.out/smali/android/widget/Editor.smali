...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/widget/Editor$MouseActionPopupWindow;,
...
.field private mMouseActionPopupWindow:Landroid/widget/Editor$MouseActionPopupWindow;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    .line 171
    iput v0, p0, Landroid/widget/Editor;->mLastWTButtonState:I

    .line 174
    iput-boolean v0, p0, Landroid/widget/Editor;->mIsPreFocused:Z
...
.method static synthetic access$1300(Landroid/widget/Editor;)Z
    ...
    .prologue
    .line 109
    invoke-direct {p0}, Landroid/widget/Editor;->isWebtopMode()Z
...
.method static synthetic access$1400(Landroid/widget/Editor;)I
    .locals 1
    .parameter "x0"

    .prologue
    .line 109
    iget v0, p0, Landroid/widget/Editor;->mLastWTButtonState:I
...
.method private showMouseActionPopupWindow()V
    ...
    .prologue
    .line 3060
    iget-object v0, p0, Landroid/widget/Editor;->mMouseActionPopupWindow:Landroid/widget/Editor$MouseActionPopupWindow;

    if-nez v0, :cond_0

    .line 3061
    new-instance v0, Landroid/widget/Editor$MouseActionPopupWindow;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Landroid/widget/Editor$MouseActionPopupWindow;-><init>(Landroid/widget/Editor;Landroid/widget/Editor$1;)V

    iput-object v0, p0, Landroid/widget/Editor;->mMouseActionPopupWindow:Landroid/widget/Editor$MouseActionPopupWindow;

    .line 3063
    :cond_0
    iget-object v0, p0, Landroid/widget/Editor;->mMouseActionPopupWindow:Landroid/widget/Editor$MouseActionPopupWindow;

    invoke-virtual {v0}, Landroid/widget/Editor$MouseActionPopupWindow;->show()V
...
.method onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/widget/Editor$MouseActionPopupWindow;->isShowing()Z
    ...
    invoke-virtual {v0}, Landroid/widget/Editor$MouseActionPopupWindow;->hide()V
...
.method onFocusChanged(ZI)V
    ...
    .line 944
    :cond_d
    iget-object v5, p0, Landroid/widget/Editor;->mMouseActionPopupWindow:Landroid/widget/Editor$MouseActionPopupWindow;

    if-eqz v5, :cond_8

    iget-object v5, p0, Landroid/widget/Editor;->mMouseActionPopupWindow:Landroid/widget/Editor$MouseActionPopupWindow;

    invoke-virtual {v5}, Landroid/widget/Editor$MouseActionPopupWindow;->isShowing()Z
    ...
    invoke-virtual {v5}, Landroid/widget/Editor$MouseActionPopupWindow;->hide()V
...
.method onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1030
    .local v2, isWTMouseEvent:Z
    const/4 v3, 0x0

    .line 1031
    .local v3, isWTMouseLeftButton:Z
    const/4 v4, 0x0

    .line 1032
    .local v4, isWTMouseRightButton:Z
    const/4 v1, 0x1

    .line 1033
    .local v1, isWTEventToBeRaised:Z
    invoke-direct {p0}, Landroid/widget/Editor;->isWebtopMode()Z
    ...
    iget v7, p0, Landroid/widget/Editor;->mLastWTButtonState:I
    ...
    :cond_0
    :goto_0
    iget v5, p0, Landroid/widget/Editor;->mLastWTButtonState:I

    .line 1050
    .local v5, lastButtonState:I
    iput v0, p0, Landroid/widget/Editor;->mLastWTButtonState:I
    ...
    .line 1061
    iput-boolean v8, p0, Landroid/widget/Editor;->mIsPreFocused:Z
    ...
    .end local v5           #lastButtonState:I
    :cond_3
    :goto_4
    invoke-virtual {p0}, Landroid/widget/Editor;->hasSelectionController()Z
    ...
    invoke-virtual {v7, p1}, Landroid/widget/Editor$SelectionModifierCursorController;->onTouchEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {v7, v10}, Landroid/widget/TextView;->removeCallbacks(Ljava/lang/Runnable;)Z
    ...
    iput v7, p0, Landroid/widget/Editor;->mLastDownPositionX:F
    ...
    iput v7, p0, Landroid/widget/Editor;->mLastDownPositionY:F

    .line 1087
    iput-boolean v9, p0, Landroid/widget/Editor;->mTouchFocusSelected:Z

    .line 1088
    iput-boolean v9, p0, Landroid/widget/Editor;->mIgnoreActionUpEvent:Z
    ...
    invoke-static {v7, v6}, Landroid/text/Selection;->setSelection(Landroid/text/Spannable;I)V
    ...
    invoke-static {v10, v7}, Landroid/text/method/MetaKeyKeyListener;->startSelecting(Landroid/view/View;Landroid/text/Spannable;)V
    ...
    .line 1113
    iget-object v7, p0, Landroid/widget/Editor;->mMouseActionPopupWindow:Landroid/widget/Editor$MouseActionPopupWindow;

    if-eqz v7, :cond_11

    iget-object v7, p0, Landroid/widget/Editor;->mMouseActionPopupWindow:Landroid/widget/Editor$MouseActionPopupWindow;

    invoke-virtual {v7}, Landroid/widget/Editor$MouseActionPopupWindow;->isShowing()Z
    ...
    invoke-virtual {v7}, Landroid/widget/Editor$MouseActionPopupWindow;->updatePosition()V
    ...
    .line 1042
    .restart local v0       #buttonState:I
    :cond_c
    iget-object v7, p0, Landroid/widget/Editor;->mTextView:Landroid/widget/TextView;
    ...
    invoke-static {v7, v10}, Landroid/text/method/MetaKeyKeyListener;->getMetaState(Ljava/lang/CharSequence;I)I
    ...
    invoke-static {v10, v7}, Landroid/text/method/MetaKeyKeyListener;->stopSelecting(Landroid/view/View;Landroid/text/Spannable;)V

    goto/16 :goto_0

    .restart local v5       #lastButtonState:I
    :cond_d
    move v2, v9
    ...
    .line 1121
    invoke-direct {p0}, Landroid/widget/Editor;->showMouseActionPopupWindow()V
    ...
    invoke-virtual {v7}, Landroid/widget/Editor$MouseActionPopupWindow;->hide()V
    ...
    iget-boolean v7, p0, Landroid/widget/Editor;->mIsPreFocused:Z

    if-eqz v7, :cond_15

    .line 1131
    iput-boolean v9, p0, Landroid/widget/Editor;->mIsPreFocused:Z
...
.method public performLongClick(Z)Z
    ...
    iget v6, p0, Landroid/widget/Editor;->mLastWTButtonState:I
