...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/os/Process;->DEBUG_6PA_KPI:Z
...
.method private static zygoteSendArgsAndGetResult(Ljava/util/ArrayList;)Landroid/os/Process$ProcessStartResult;
    ...
    .line 503
    :try_start_0
    sget-object v8, Landroid/os/Process;->sZygoteWriter:Ljava/io/BufferedWriter;
    ...
    .line 510
    new-instance v8, Landroid/os/ZygoteStartFailedEx;

    const-string v9, "embedded newlines not allowed"

    invoke-direct {v8, v9}, Landroid/os/ZygoteStartFailedEx;-><init>(Ljava/lang/String;)V
    ...
    :try_start_1
    sget-object v8, Landroid/os/Process;->sZygoteSocket:Landroid/net/LocalSocket;
    ...
    sput-object v8, Landroid/os/Process;->sZygoteSocket:Landroid/net/LocalSocket;

    .line 571
    new-instance v8, Landroid/os/ZygoteStartFailedEx;

    invoke-direct {v8, v1}, Landroid/os/ZygoteStartFailedEx;-><init>(Ljava/lang/Throwable;)V
    ...
    .end local v0           #arg:Ljava/lang/String;
    :cond_2
    sget-boolean v8, Landroid/os/Process;->DEBUG_6PA_KPI:Z
    ...
    .line 520
    .local v5, niceName:Ljava/lang/String;
    const/4 v3, 0x0
    ...
    const-string v10, " call sZygoteWriter.flush() for unknown --nice-name"
    ...
    .line 537
    .end local v5           #niceName:Ljava/lang/String;
    :cond_4
    :goto_3
    sget-object v8, Landroid/os/Process;->sZygoteWriter:Ljava/io/BufferedWriter;
    ...
    .line 540
    new-instance v6, Landroid/os/Process$ProcessStartResult;

    invoke-direct {v6}, Landroid/os/Process$ProcessStartResult;-><init>()V

    .line 541
    .local v6, result:Landroid/os/Process$ProcessStartResult;
    sget-object v8, Landroid/os/Process;->sZygoteInputStream:Ljava/io/DataInputStream;

    invoke-virtual {v8}, Ljava/io/DataInputStream;->readInt()I

    move-result v8

    iput v8, v6, Landroid/os/Process$ProcessStartResult;->pid:I
    ...
    const-string v10, " result.pid = sZygoteInputStream.readInt() = "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget v10, v6, Landroid/os/Process$ProcessStartResult;->pid:I
    ...
    .line 547
    const-string/jumbo v8, "startActivityMayWait"

    invoke-static {v8}, Lcom/motorola/kpi/Kpi6paTop;->get(Ljava/lang/String;)Lcom/motorola/kpi/Kpi6paTop;

    move-result-object v4

    .line 548
    .local v4, kpi6paTop:Lcom/motorola/kpi/Kpi6paTop;
    if-eqz v4, :cond_5

    .line 549
    invoke-virtual {v4}, Lcom/motorola/kpi/Kpi6paTop;->append()V

    .line 554
    .end local v4           #kpi6paTop:Lcom/motorola/kpi/Kpi6paTop;
    :cond_5
    iget v8, v6, Landroid/os/Process$ProcessStartResult;->pid:I
    ...
    .line 520
    .end local v6           #result:Landroid/os/Process$ProcessStartResult;
    .restart local v0       #arg:Ljava/lang/String;
    .restart local v5       #niceName:Ljava/lang/String;
    :cond_6
    add-int/lit8 v3, v3, 0x1
    ...
    const-string v10, " call sZygoteWriter.flush() for "
    ...
    .line 557
    .end local v5           #niceName:Ljava/lang/String;
    .restart local v6       #result:Landroid/os/Process$ProcessStartResult;
    :cond_8
    sget-object v8, Landroid/os/Process;->sZygoteInputStream:Ljava/io/DataInputStream;
    ...
    iput-boolean v8, v6, Landroid/os/Process$ProcessStartResult;->usingWrapper:Z
    :try_end_2
    ...
    const-string v9, "I/O exception on routine close"
