...
.method private setScanAlarm(Z)V
    ...
    invoke-static {v6}, Landroid/net/wifi/WifiStateMachine;->access$16200(Landroid/net/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mScanIntent:Landroid/app/PendingIntent;
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$16200(Landroid/net/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
...
.method public enter()V
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiStateMachine;->access$16400(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/MotWifiScan;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v5}, Landroid/net/wifi/WifiStateMachine;->access$16504(Landroid/net/wifi/WifiStateMachine;)I
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mSupplicantScanIntervalMs:J
    invoke-static {v4}, Landroid/net/wifi/WifiStateMachine;->access$6700(Landroid/net/wifi/WifiStateMachine;)J
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$6502(Landroid/net/wifi/WifiStateMachine;Z)Z
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mMotWifiScan:Landroid/net/wifi/MotWifiScan;
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$16400(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/MotWifiScan;
    ...
    #calls: Landroid/net/wifi/WifiStateMachine;->handlePendingEapAuth()V
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$16700(Landroid/net/wifi/WifiStateMachine;)V
