...
.field private static final DISPLAY_CONTEXT_MENU:I = 0xc
...
.field private static final MAX_SCROLL_PACE:I = 0x60
...
.field private static final SUBLAYER_SCROLL_TIMEOUT:I = 0x3e8
...
.field private mLastSublayerScrollTime:J
...
.method public constructor <init>(Landroid/webkit/WebView;Landroid/webkit/WebView$PrivateAccess;)V
    ...
    .line 687
    iput-object v7, p0, Landroid/webkit/WebViewClassic;->mListBoxDialog:Landroid/app/AlertDialog;
    ...
    .line 697
    iput-object v7, p0, Landroid/webkit/WebViewClassic;->mInputConnection:Landroid/webkit/WebViewClassic$WebViewInputConnection;
    ...
    .line 707
    iput-wide v4, p0, Landroid/webkit/WebViewClassic;->mLastEditScroll:J
    ...
    .line 1155
    iput-wide v4, p0, Landroid/webkit/WebViewClassic;->mLastSublayerScrollTime:J

    .line 1178
    iput-wide v4, p0, Landroid/webkit/WebViewClassic;->mLastTouchUpTime:J
    ...
    .line 3691
    iput-object v7, p0, Landroid/webkit/WebViewClassic;->mFindRequest:Landroid/webkit/WebViewCore$FindAllRequest;
    ...
    .line 4639
    iput-object v7, p0, Landroid/webkit/WebViewClassic;->mHistoryPicture:Landroid/graphics/Picture;
    ...
    .line 6562
    iput-wide v4, p0, Landroid/webkit/WebViewClassic;->mTrackballFirstTime:J

    .line 6563
    iput-wide v4, p0, Landroid/webkit/WebViewClassic;->mTrackballLastTime:J
    ...
    .line 6583
    iput-wide v4, p0, Landroid/webkit/WebViewClassic;->mTrackballUpTime:J

    .line 6584
    iput-wide v4, p0, Landroid/webkit/WebViewClassic;->mLastCursorTime:J

    .line 6586
    new-instance v0, Landroid/webkit/WebViewClassic$SelectionHandleAlpha;

    invoke-direct {v0, p0, v7}, Landroid/webkit/WebViewClassic$SelectionHandleAlpha;-><init>(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewClassic$1;)V
...
.method static synthetic access$3402(Landroid/webkit/WebViewClassic;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$4300(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebView$PrivateAccess;
    .locals 1
    .parameter "x0"
...
.method private handleTouchEventCommon(Landroid/view/MotionEvent;III)V
    ...
    invoke-virtual {v3}, Landroid/webkit/WebView$PrivateAccess;->super_isWebtopMode()Z
...
.method private onActionScroll(Landroid/view/MotionEvent;II)Z
    .locals 12
    .parameter "event"
    .parameter "deltaX"
    .parameter "deltaY"
    ...
    .line 6449
    iget-object v0, p0, Landroid/webkit/WebViewClassic;->mScrollingLayerBounds:Landroid/graphics/Rect;
    ...
    .line 6455
    invoke-direct {p0, p3}, Landroid/webkit/WebViewClassic;->viewToContentDimension(I)I
    ...
    iput-wide v0, p0, Landroid/webkit/WebViewClassic;->mLastSublayerScrollTime:J
    ...
    iget-wide v4, p0, Landroid/webkit/WebViewClassic;->mLastSublayerScrollTime:J
...
.method private onHandleUiEvent(Landroid/view/MotionEvent;II)V
    ...
    invoke-virtual {v1}, Landroid/webkit/WebView$PrivateAccess;->super_isWebtopMode()Z
...
.method private setupWebkitSelect()Z
    ...
    .line 5225
    iput-boolean v0, p0, Landroid/webkit/WebViewClassic;->mSelectionStarted:Z

    .line 5226
    iget-object v1, p0, Landroid/webkit/WebViewClassic;->mSelectHandleRightOffset:Landroid/graphics/Point;

    iput-object v1, p0, Landroid/webkit/WebViewClassic;->mSelectDraggingOffset:Landroid/graphics/Point;

    .line 5227
    iget-object v1, p0, Landroid/webkit/WebViewClassic;->mSelectCursorRight:Landroid/graphics/Point;

    iput-object v1, p0, Landroid/webkit/WebViewClassic;->mSelectDraggingCursor:Landroid/graphics/Point;

    .line 5228
    iget-object v1, p0, Landroid/webkit/WebViewClassic;->mSelectCursorRightTextQuad:Landroid/webkit/QuadF;

    iput-object v1, p0, Landroid/webkit/WebViewClassic;->mSelectDraggingTextQuad:Landroid/webkit/QuadF;
...
.method public cutSelectedText()V
    .locals 1
    ...
    .line 5306
    invoke-virtual {p0}, Landroid/webkit/WebViewClassic;->cutSelection()V
...
.method public isCutSelectionAllowed()Z
    .locals 1
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v5}, Landroid/webkit/WebView$PrivateAccess;->super_isWebtopMode()Z

    move-result v5

    if-eqz v5, :cond_5

    invoke-direct {p0, p1, v0, v2}, Landroid/webkit/WebViewClassic;->onActionScroll(Landroid/view/MotionEvent;II)Z
    ...
    .line 6552
    :cond_5
    invoke-direct {p0, v0, v2, v8, v8}, Landroid/webkit/WebViewClassic;->pinScrollBy(IIZI)Z
    ...
    .line 6538
    .restart local v0       #hdelta:I
    .restart local v2       #vdelta:I
    :cond_7
    if-ge v0, v7, :cond_3
...
.method selectText(II)Z
    ...
    invoke-virtual {v0}, Landroid/webkit/WebView$PrivateAccess;->super_isWebtopMode()Z
