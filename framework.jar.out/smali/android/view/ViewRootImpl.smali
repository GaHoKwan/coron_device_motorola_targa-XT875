...
.field static final LOG_DRAW_FILE_NAME:Ljava/lang/String; = "debug.vr.logdraw"
...
.field mDrawPerfLog:Lcom/motorola/android/util/PerfLog;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 419
    new-instance v0, Lcom/motorola/android/util/PerfLog;

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "Active Draw Times, win="
    ...
    invoke-direct {v0, v1}, Lcom/motorola/android/util/PerfLog;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Landroid/view/ViewRootImpl;->mDrawPerfLog:Lcom/motorola/android/util/PerfLog;

    .line 420
    iget-object v0, p0, Landroid/view/ViewRootImpl;->mDrawPerfLog:Lcom/motorola/android/util/PerfLog;

    const-string v1, "debug.vr.logdraw"

    invoke-virtual {v0, p1, v1}, Lcom/motorola/android/util/PerfLog;->enableOnFileExists(Landroid/content/Context;Ljava/lang/String;)V

    .line 421
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Landroid/view/ViewRootImpl;->mLastSampleEnd:J
...
.method private deliverPointerEvent(Landroid/view/ViewRootImpl$QueuedInputEvent;)V
    ...
    .line 3275
    :cond_8
    iget-object v4, p0, Landroid/view/ViewRootImpl;->mDrawPerfLog:Lcom/motorola/android/util/PerfLog;

    const-string v5, "T"

    invoke-virtual {v4, v5}, Lcom/motorola/android/util/PerfLog;->addSampleInfo(Ljava/lang/String;)V
...
.method private draw(Z)V
    ...
    iget-object v4, v0, Landroid/view/ViewRootImpl;->mDrawPerfLog:Lcom/motorola/android/util/PerfLog;

    const-string v18, "D"

    move-object/from16 v0, v18

    invoke-virtual {v4, v0}, Lcom/motorola/android/util/PerfLog;->addSampleInfo(Ljava/lang/String;)V
    ...
    invoke-virtual {v4}, Lcom/motorola/android/util/PerfLog;->finishSample()V
    ...
    iput-wide v0, v2, Landroid/view/ViewRootImpl;->mLastSampleEnd:J

    .line 2246
    move-object/from16 v0, p0

    iget-boolean v4, v0, Landroid/view/ViewRootImpl;->mTraversalScheduled:Z
...
.method private drawSoftware(Landroid/view/Surface;Landroid/view/View$AttachInfo;IZLandroid/graphics/Rect;)Z
    ...
    .line 2356
    iget-object v8, p0, Landroid/view/ViewRootImpl;->mDrawPerfLog:Lcom/motorola/android/util/PerfLog;

    const-string v9, "D"

    invoke-virtual {v8, v9}, Lcom/motorola/android/util/PerfLog;->addSampleInfo(Ljava/lang/String;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method private performTraversals()V
    ...
    iget-boolean v4, v4, Lcom/motorola/android/util/PerfLog;->mEnabled:Z
    ...
    const-string v11, "Active Draw Times, win="
    ...
    iput-object v10, v4, Lcom/motorola/android/util/PerfLog;->mId:Ljava/lang/String;
    ...
    .line 1330
    .local v64, systemUiVisibilityReady:Z
    ...
    .end local v64           #systemUiVisibilityReady:Z
    ...
    .restart local v64       #systemUiVisibilityReady:Z
    :cond_1b
    if-nez v57, :cond_1c
    ...
    invoke-virtual {v4, v10}, Lcom/motorola/android/util/PerfLog;->addSampleInfo(Ljava/lang/String;)V
    ...
    invoke-virtual {v4}, Lcom/motorola/android/util/PerfLog;->sampleStarted()Z
    ...
    invoke-virtual {v4}, Lcom/motorola/android/util/PerfLog;->cancelSample()V
    ...
    invoke-virtual {v4}, Lcom/motorola/android/util/PerfLog;->flushSamples()V
...
.method doConsumeBatchedInput(J)V
    ...
    invoke-virtual {v0, v1}, Lcom/motorola/android/util/PerfLog;->startSample(Z)V

    .line 4318
    :cond_0
    iput-boolean v1, p0, Landroid/view/ViewRootImpl;->mConsumeBatchedInputScheduled:Z
...
.method doDie()V
    ...
    .line 4098
    iget-object v2, p0, Landroid/view/ViewRootImpl;->mDrawPerfLog:Lcom/motorola/android/util/PerfLog;

    invoke-virtual {v2}, Lcom/motorola/android/util/PerfLog;->flushSamples()V
...
.method doTraversal()V
    ...
    invoke-virtual {v0, v4}, Lcom/motorola/android/util/PerfLog;->startSample(Z)V

    .line 1035
    iget-wide v0, p0, Landroid/view/ViewRootImpl;->mLastSampleEnd:J
    ...
    invoke-virtual {v0, v1}, Lcom/motorola/android/util/PerfLog;->addSampleInfo(Ljava/lang/String;)V
...
.method handleAppVisibility(Z)V
    ...
    invoke-virtual {v0}, Lcom/motorola/android/util/PerfLog;->cancelSample()V

    .line 822
    iget-object v0, p0, Landroid/view/ViewRootImpl;->mDrawPerfLog:Lcom/motorola/android/util/PerfLog;

    invoke-virtual {v0}, Lcom/motorola/android/util/PerfLog;->flushSamples()V
