...
.method public declared-synchronized setIndex(IIZ)Z
    ...
    .line 2583
    .local v5, updatedAliasStreams:I
    ...
    invoke-static {v8, v9}, Landroid/media/AudioService;->access$3700(Landroid/media/AudioService;I)I
    ...
    #getter for: Landroid/media/AudioService;->mStreamVolumeAlias:[I
    invoke-static {v8}, Landroid/media/AudioService;->access$3500(Landroid/media/AudioService;)[I
    ...
    #calls: Landroid/media/AudioService;->rescaleIndex(III)I
    invoke-static {v8, p1, v9, v4}, Landroid/media/AudioService;->access$3800(Landroid/media/AudioService;III)I
    ...
    invoke-static {v8}, Landroid/media/AudioService;->access$3900(Landroid/media/AudioService;)[Landroid/media/AudioService$VolumeStreamState;

    move-result-object v8

    aget-object v8, v8, v4

    invoke-virtual {v8, v3, p2, p3}, Landroid/media/AudioService$VolumeStreamState;->setIndex(IIZ)Z
    ...
    #calls: Landroid/media/AudioService;->getDeviceForStream(I)I
    invoke-static {v9, v4}, Landroid/media/AudioService;->access$3700(Landroid/media/AudioService;I)I

    move-result v9

    invoke-virtual {v8, v3, v9, p3}, Landroid/media/AudioService$VolumeStreamState;->setIndex(IIZ)Z
    ...
    .end local v4           #streamType:I
    .end local v5           #updatedAliasStreams:I
    :catchall_0
    move-exception v6
