...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v2, v0}, Landroid/media/AudioService;->access$5202(Landroid/media/AudioService;I)I
    ...
    invoke-static {v2}, Landroid/media/AudioService;->access$2800(Landroid/media/AudioService;)Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v2, v3}, Landroid/media/AudioService;->access$5502(Landroid/media/AudioService;I)I

    .line 3548
    :goto_3
    new-instance v33, Landroid/content/Intent;

    const-string v2, "com.motorola.internal.intent.action.MEDIA_SPEAKER_STATE_CHANGE"
    ...
    .line 3549
    .local v33, update:Landroid/content/Intent;
    const-string v2, "enabled"
    ...
    .line 3545
    .end local v33           #update:Landroid/content/Intent;
    :cond_6
    const/4 v2, 0x1
    ...
    invoke-static {v2, v0, v1, v13}, Landroid/media/AudioService;->access$7300(Landroid/media/AudioService;ZILjava/lang/String;)Z
    ...
    #calls: Landroid/media/AudioService;->handleDeviceConnection(ZILjava/lang/String;)Z
    invoke-static {v3, v2, v0, v1}, Landroid/media/AudioService;->access$7300(Landroid/media/AudioService;ZILjava/lang/String;)Z
    ...
    invoke-static {v3, v2}, Landroid/media/AudioService;->access$7502(Landroid/media/AudioService;Landroid/app/KeyguardManager;)Landroid/app/KeyguardManager;
    ...
    invoke-static {v2, v3}, Landroid/media/AudioService;->access$7602(Landroid/media/AudioService;I)I
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$7700(Landroid/media/AudioService;)Landroid/bluetooth/BluetoothProfile$ServiceListener;
    ...
    invoke-static {v2, v0}, Landroid/media/AudioService;->access$7800(Landroid/media/AudioService;Ljava/lang/String;)V
    ...
    invoke-static {v2, v0}, Landroid/media/AudioService;->access$7900(Landroid/media/AudioService;Landroid/content/Context;)V
    ...
    const-string/jumbo v3, "ro.mot.fid.30544.tty"
    ...
    .line 3714
    const-string/jumbo v32, "tty_off"

    .line 3716
    .local v32, tty_mode:Ljava/lang/String;
    :goto_d
    new-instance v2, Ljava/lang/StringBuilder;
    ...
    .line 3704
    .end local v32           #tty_mode:Ljava/lang/String;
    :pswitch_7
    const-string/jumbo v32, "tty_full"

    .line 3705
    .restart local v32       #tty_mode:Ljava/lang/String;
    goto :goto_d

    .line 3707
    .end local v32           #tty_mode:Ljava/lang/String;
    :pswitch_8
    const-string/jumbo v32, "tty_vco"
    ...
    .end local v32           #tty_mode:Ljava/lang/String;
    :pswitch_9
    const-string/jumbo v32, "tty_hco"
