...
.field private mBrightnessPanel:Landroid/view/BrightnessPanel;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->DEBUG_6PA_KPI:Z
...
.method public constructor <init>()V
    ...
    iput-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBrightnessPanel:Landroid/view/BrightnessPanel;
...
.method static synthetic access$600(Lcom/android/internal/policy/impl/PhoneWindowManager;)Landroid/view/BrightnessPanel;
    .locals 1
    .parameter "x0"

    .prologue
    .line 185
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBrightnessPanel:Landroid/view/BrightnessPanel;

    return-object v0
.end method

.method static synthetic access$602(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/view/BrightnessPanel;)Landroid/view/BrightnessPanel;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 185
    iput-object p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBrightnessPanel:Landroid/view/BrightnessPanel;

    return-object p1
.end method

.method static synthetic access$700(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/content/Context;)J
    .locals 2
    .parameter "x0"
    .parameter "x1"
...
.method private handleLongPressOnHome()V
    ...
    :cond_0
    :goto_0
    iget-boolean v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCooldownMode:Z
    ...
    const-string v6, "Ignoring Long Press HOME;in cooldown mode or there\'s a ringing incoming call"
...
.method public addStartingWindow(Landroid/os/IBinder;Ljava/lang/String;ILandroid/content/res/CompatibilityInfo;Ljava/lang/CharSequence;III)Landroid/view/View;
    ...
    .line 1619
    :cond_1
    sget-boolean v10, Lcom/android/internal/policy/impl/PhoneWindowManager;->DEBUG_6PA_KPI:Z

    if-eqz v10, :cond_2

    .line 1620
    const-string v10, "KPI-6PA-WMS-1"
    ...
    const-string v12, " enter PhoneWindowManager.addStartingWindow() "
    ...
    invoke-virtual {v2, v0, v10}, Landroid/content/Context;->createPackageContext(Ljava/lang/String;I)Landroid/content/Context;
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;Landroid/os/LocalPowerManager;)V
    ...
    const v6, #android:integer@config_defaultUiModeType#t
    ...
    iget-object v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    const v6, #android:bool@config_voiceKeyDefinedAsShiftTab#t

    invoke-virtual {v5, v6}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v5

    iput-boolean v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVoiceKeyDefinedAsShiftTab:Z
    ...
    invoke-static {v5}, Lcom/motorola/errorprevention/InsertionErrorPrevention;->getInstance(Landroid/content/res/Resources;)Lcom/motorola/errorprevention/InsertionErrorPrevention;

    move-result-object v5

    iput-object v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mErrorPrevention:Lcom/motorola/errorprevention/InsertionErrorPrevention;
    ...
    const-string v5, "com.motorola.internal.intent.action.LD_BRIGHTNESS_CHANGED"
    ...
    iget-object v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBrightnessReceiver:Landroid/content/BroadcastReceiver;
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    .end local v31           #keyguardActive:Z
    :cond_1
    const/16 v26, 0x0
    ...
    .line 3524
    .restart local v31       #keyguardActive:Z
    :cond_5
    ...
    invoke-virtual {v2, v11, v12}, Landroid/hardware/input/InputManager;->injectInputEvent(Landroid/view/InputEvent;I)Z
    ...
    invoke-virtual {v2, v12, v13, v0, v5}, Lcom/motorola/errorprevention/InsertionErrorPrevention;->isFalseHardKey(JZI)Z
    ...
    invoke-virtual {v2, v12, v13}, Landroid/os/Handler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method public removeStartingWindow(Landroid/os/IBinder;Landroid/view/View;)V
    ...
    .prologue
    .line 1724
    sget-boolean v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->DEBUG_6PA_KPI:Z

    if-eqz v1, :cond_0

    .line 1725
    const-string v1, "KPI-6PA-WMS-7"
    ...
    const-string v3, " enter PhoneWindowManager.removeStartingWindow(): "
...
.method public updateSettings()V
    ...
    const v12, #android:bool@config_enableDreams#t
