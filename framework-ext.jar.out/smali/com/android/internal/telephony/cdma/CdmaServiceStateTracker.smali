...
.field private static final PROP_SYS_MOT_ENCRYPT_GOINGON:Ljava/lang/String; = "mot.encrypt.goingon"

.field private static final PROP_SYS_MOT_ENCRYPT_GOINGON_NO:Ljava/lang/String; = "0"

.field private static final PROP_SYS_MOT_ENCRYPT_GOINGON_YES:Ljava/lang/String; = "1"
...
.method public constructor <init>(ILcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker$2;-><init>(Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;)V

    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIntentReceiver:Landroid/content/BroadcastReceiver;

    .line 274
    new-instance v0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker$3;

    new-instance v1, Landroid/os/Handler;

    invoke-direct {v1}, Landroid/os/Handler;-><init>()V

    invoke-direct {v0, p0, v1}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker$3;-><init>(Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;Landroid/os/Handler;)V
...
.method public constructor <init>(ZZLcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    .line 432
    invoke-virtual {p3}, Lcom/android/internal/telephony/PhoneBase;->getContext()Landroid/content/Context;
    ...
    .line 437
    invoke-virtual {p3}, Lcom/android/internal/telephony/PhoneBase;->getIccCard()Lcom/android/internal/telephony/IccCard;
...
.method static synthetic access$100(Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;Landroid/telephony/ServiceState;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 96
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->updateCdmaOperatorName(Landroid/telephony/ServiceState;)V
...
.method private activateMe()V
    ...
    invoke-interface {v6, p0, v7, v8}, Lcom/android/internal/telephony/CommandsInterface;->registerForCdmaPrlChanged(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 342
    iget-boolean v6, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIsNewArch:Z

    if-eqz v6, :cond_4

    .line 343
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIccCardManager:Lcom/motorola/android/internal/telephony/IccCardManager;

    const/16 v7, 0x29

    invoke-virtual {v6, p0, v7, v8}, Lcom/motorola/android/internal/telephony/IccCardManager;->registerForIccChanged(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 351
    :goto_0
    iget-boolean v6, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isEriSupported:Z
    ...
    invoke-virtual {v6, p0, v7, v8}, Lcom/android/internal/telephony/cdma/CDMAPhone;->registerForEriFileLoaded(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v6, p0, v7, v8}, Lcom/android/internal/telephony/CommandsInterface;->registerForCdmaOtaProvision(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    const-string v6, "mot.encrypt.goingon"
    ...
    .line 361
    .local v3, strEncryptionGoingon:Ljava/lang/String;
    const/4 v1, 0x0

    .line 362
    .local v1, encryptionGoingon:Z
    if-eqz v3, :cond_1
    ...
    const-string v7, "get encryption status "
    ...
    .end local v1           #encryptionGoingon:Z
    .end local v2           #filter:Landroid/content/IntentFilter;
    .end local v3           #strEncryptionGoingon:Ljava/lang/String;
    :cond_4
    ...
    .restart local v1       #encryptionGoingon:Z
    .restart local v3       #strEncryptionGoingon:Ljava/lang/String;
    :cond_5
...
.method private initialize()V
    ...
    invoke-static {v1, v3, p0, v4, v5}, Lcom/android/internal/telephony/cdma/CdmaSubscriptionSourceManager;->getInstance(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Landroid/os/Handler;ILjava/lang/Object;)Lcom/android/internal/telephony/cdma/CdmaSubscriptionSourceManager;
    ...
    invoke-direct {v1, v3}, Lcom/motorola/android/telephony/SUPForAssistedDialing;-><init>(Lcom/android/internal/telephony/Phone;)V
    ...
    invoke-direct {v1, v3}, Lcom/motorola/android/telephony/cdma/CdmaPCDHandler;-><init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
...
.method private updateCdmaOperatorName(Landroid/telephony/ServiceState;)V
    ...
    const-string v9, "[CDMA_OPERATOR_NAME] plmnNumeric = "
    ...
    .line 2632
    iget-boolean v8, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isSubscriptionFromRuim:Z
    ...
    invoke-virtual {v8}, Lcom/android/internal/telephony/IccCard;->getRuimState()Lcom/android/internal/telephony/IccCard$State;
    ...
    iget-boolean v8, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isEriSupported:Z
    ...
    invoke-virtual {v8, v0}, Landroid/telephony/ServiceState;->setOperatorAlphaLong(Ljava/lang/String;)V
    ...
    const-string v9, "gsm.operator.alpha"
    ...
    invoke-virtual {v8, v9, v10}, Lcom/android/internal/telephony/cdma/CDMAPhone;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v8, v1}, Lcom/motorola/android/telephony/cdma/CdmaOperatorHelper;->getOperatorInfo(Landroid/content/Context;I)Lcom/motorola/android/telephony/cdma/CdmaOperatorInfo;

    move-result-object v8

    iget-object v3, v8, Lcom/motorola/android/telephony/cdma/CdmaOperatorInfo;->mOperatorName:Ljava/lang/String;
    :try_end_0
    ...
    const-string v9, "[CDMA_OPERATOR_NAME] plmn from MCC/MNC = "
    ...
    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mSavedTimeZone:Ljava/lang/String;
    ...
    const-string v9, "[CDMA_OPERATOR_NAME] nid = "
    ...
    const-string v9, " mSavedTimeZone = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mSavedTimeZone:Ljava/lang/String;
    ...
    invoke-static {v8, v5, v2, v7}, Lcom/motorola/android/telephony/cdma/CdmaOperatorHelper;->getOperatorInfo(Landroid/content/Context;III)Lcom/motorola/android/telephony/cdma/CdmaOperatorInfo;
    ...
    .line 2676
    .end local v2           #nid:I
    .end local v7           #timeZoneOffset:I
    :cond_7
    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "[CDMA_OPERATOR_NAME] plmn from SID = "
    ...
    .line 2678
    :cond_8
    invoke-virtual {p1, v3, v3, v4}, Landroid/telephony/ServiceState;->setOperatorName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v22, "Received OTA_PROGRAMMING Complete,Reload MDN "
    ...
    .line 881
    .end local v10           #ar:Landroid/os/AsyncResult;
    .end local v14           #imsiMsg:Landroid/os/Message;
    :pswitch_13
    move-object/from16 v0, p1
...
.method protected pollStateDone()V
    ...
    invoke-virtual/range {v29 .. v30}, Landroid/telephony/ServiceState;->setDataState(I)V
    ...
    .line 1503
    .local v13, hasEmergencyOnlyChanged:Z
    :goto_9
    new-instance v29, Ljava/lang/StringBuilder;
    ...
    invoke-virtual/range {v29 .. v29}, Lcom/android/internal/telephony/IccCard;->getRuimState()Lcom/android/internal/telephony/IccCard$State;
    ...
    invoke-virtual {v0, v1, v5}, Lcom/android/internal/telephony/cdma/EriManager;->getCdmaEriText(II)Ljava/lang/String;

    move-result-object v6

    .line 1549
    .end local v5           #defRoamInd:I
    ...
    .line 1655
    .local v22, networkTypeString:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 1725
    .end local v22           #networkTypeString:Ljava/lang/String;
    ...
    .end local v13           #hasEmergencyOnlyChanged:Z
    ...
    .line 1546
    .restart local v13       #hasEmergencyOnlyChanged:Z
    :cond_21
    move-object/from16 v0, p0
    ...
    .line 1667
    .end local v6           #eriText:Ljava/lang/String;
    .restart local v22       #networkTypeString:Ljava/lang/String;
...
.method protected updateSpnDisplay()V
    ...
    .line 935
    .local v5, rule:I
    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIccRecords:Lcom/android/internal/telephony/IccRecords;

    if-eqz v9, :cond_b

    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mIccRecords:Lcom/android/internal/telephony/IccRecords;

    invoke-virtual {v9}, Lcom/android/internal/telephony/IccRecords;->getIccCard()Lcom/android/internal/telephony/IccCard;
    ...
    invoke-virtual {v9}, Lcom/android/internal/telephony/IccCard;->getRuimState()Lcom/android/internal/telephony/IccCard$State;
    ...
    .line 940
    iget-boolean v9, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isEriSupported:Z
    ...
    invoke-virtual {v11}, Landroid/telephony/ServiceState;->getNetworkId()I

    move-result v11

    invoke-virtual {p0, v10, v11}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isInHomeSidNid(II)Z

    move-result v10

    invoke-virtual {v9, v10}, Lcom/android/internal/telephony/IccRecords;->getDisplayRule(Z)I
    ...
    const-string v10, "updateSpnDisplay(): rule= "
    ...
    invoke-virtual {v9}, Lcom/android/internal/telephony/PhoneBase;->getIccCard()Lcom/android/internal/telephony/IccCard;
    ...
    sget-object v10, Lcom/android/internal/telephony/IccCard$State;->ERROR:Lcom/android/internal/telephony/IccCard$State;
    ...
    iget v10, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->curSpnRule:I
    ...
    iget-object v10, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->curSpn:Ljava/lang/String;
    ...
    iget-boolean v10, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->curExtraNoSpnCondition:Z
    ...
    .line 1001
    iget v9, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->curSpnRule:I

    if-ne v5, v9, :cond_4

    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->curSpn:Ljava/lang/String;
    ...
    iget-boolean v9, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->curExtraNoSpnCondition:Z
    ...
    .line 1013
    :cond_5
    const-string v9, "updateSpnDisplay: changed sending intent showPlmn=\'%b\' plmn=\'%s\' showSpn=\'%b\' spn=\'%s\'"
    ...
    .line 1028
    iput-object v4, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mCurPlmn:Ljava/lang/String;

    .line 1030
    iput-boolean v0, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->curExtraNoSpnCondition:Z
    ...
    invoke-direct {p0, v10}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isHomeSid(I)Z
