...
.method protected onMeasure(II)V
    ...
    invoke-virtual/range {v43 .. v43}, Landroid/view/ViewGroup;->getChildCount()I
    ...
    .line 1019
    .end local v23           #i:I
    .end local v41           #visibleChildren:I
    :cond_3
    :goto_1
    return-void
    ...
    sget-object v44, Landroid/R$styleable;->FloatingLike_Window:[I

    invoke-virtual/range {v43 .. v44}, Landroid/content/Context;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;
    ...
    const-string v45, " can only be used "

    invoke-virtual/range {v44 .. v45}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v44

    const-string v45, "with android:layout_height=\"wrap_content\""
    ...
    const-string v45, "with android:layout_width=\"match_parent\" (or fill_parent)"
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/internal/widget/ActionBarView$HomeView;->getLeftOffset()I
    ...
    invoke-virtual/range {v43 .. v43}, Landroid/view/View;->getParent()Landroid/view/ViewParent;
    ...
    check-cast v43, Landroid/app/ActionBar$LayoutParams;
    ...
    .end local v28           #lp:Landroid/view/ViewGroup$LayoutParams;
    .end local v39           #verticalMargin:I
    :cond_10
    move-object/from16 v0, p0
    ...
    .end local v31           #paddedViewHeight:I
    .end local v32           #paddingLeft:I
    .end local v33           #paddingRight:I
    .end local v34           #rightOfCenter:I
    .end local v35           #showTitle:Z
    .end local v38           #v:Landroid/view/View;
    .end local v40           #verticalPadding:I
    :cond_13
    ...
    .restart local v29       #maxHeight:I
    .restart local v32       #paddingLeft:I
    .restart local v33       #paddingRight:I
    .restart local v34       #rightOfCenter:I
    .restart local v40       #verticalPadding:I
    :cond_14
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v43 .. v45}, Landroid/view/View;->measure(II)V
    ...
    .line 925
    .restart local v25       #itemPaddingSize:I
    :goto_f
    const/16 v43, 0x0
    ...
    .restart local v39       #verticalMargin:I
    :cond_1b
    move-object/from16 v0, v28
    ...
    invoke-virtual/range {v43 .. v44}, Lcom/android/internal/widget/ActionBarContextView;->setContentHeight(I)V
