.class public Lcom/motorola/ethernet/EthernetManager;
...
.field mService:Lcom/motorola/ethernet/IEthernetManager;


# direct methods
.method public constructor <init>(Lcom/motorola/ethernet/IEthernetManager;Landroid/os/Handler;)V
    .locals 2
    .parameter "service"
    .parameter "handler"
    ...
    .line 170
    iput-object p1, p0, Lcom/motorola/ethernet/EthernetManager;->mService:Lcom/motorola/ethernet/IEthernetManager;

    .line 171
    iput-object p2, p0, Lcom/motorola/ethernet/EthernetManager;->mHandler:Landroid/os/Handler;
...
# virtual methods
.method public getConfiguration()Lcom/motorola/ethernet/EthernetConfiguration;
    .locals 2

    .prologue
    .line 266
    :try_start_0
    iget-object v1, p0, Lcom/motorola/ethernet/EthernetManager;->mService:Lcom/motorola/ethernet/IEthernetManager;

    invoke-interface {v1}, Lcom/motorola/ethernet/IEthernetManager;->getConfiguration()Lcom/motorola/ethernet/EthernetConfiguration;
    :try_end_0
...
.method public getEthernetHwState()I
    ...
    invoke-interface {v1}, Lcom/motorola/ethernet/IEthernetManager;->getEthernetHwState()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getEthernetState()I
    ...
    invoke-interface {v1}, Lcom/motorola/ethernet/IEthernetManager;->getEthernetState()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getLinkProperties()Landroid/net/LinkProperties;
    ...
    invoke-interface {v1}, Lcom/motorola/ethernet/IEthernetManager;->getLinkProperties()Landroid/net/LinkProperties;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getNetworkInfo()Landroid/net/NetworkInfo;
    ...
    invoke-interface {v1}, Lcom/motorola/ethernet/IEthernetManager;->getNetworkInfo()Landroid/net/NetworkInfo;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isEthernetEnabled()Z
    ...
    .line 237
    invoke-virtual {p0}, Lcom/motorola/ethernet/EthernetManager;->getEthernetState()I
...
.method public saveConfiguration(Lcom/motorola/ethernet/EthernetConfiguration;)Z
    .locals 2
    .parameter "config"
    ...
    invoke-interface {v1, p1}, Lcom/motorola/ethernet/IEthernetManager;->saveConfiguration(Lcom/motorola/ethernet/EthernetConfiguration;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setEthernetEnabled(Z)Z
    ...
    invoke-interface {v1, p1}, Lcom/motorola/ethernet/IEthernetManager;->setEthernetEnabled(Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method startEthernet()Z
    ...
    invoke-interface {v1}, Lcom/motorola/ethernet/IEthernetManager;->startEthernet()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method startService()Z
    ...
    invoke-interface {v1}, Lcom/motorola/ethernet/IEthernetManager;->startService()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method stopEthernet()Z
    ...
    invoke-interface {v1}, Lcom/motorola/ethernet/IEthernetManager;->stopEthernet()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
