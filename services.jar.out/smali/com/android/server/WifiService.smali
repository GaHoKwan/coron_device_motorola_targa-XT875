...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 1424
    new-instance v3, Lcom/android/server/WifiService$5;

    invoke-direct {v3, p0}, Lcom/android/server/WifiService$5;-><init>(Lcom/android/server/WifiService;)V
    ...
    .line 432
    const-string v3, "softap.interface"
    ...
    sput-object v3, Lcom/android/server/WifiService;->mSoftapIface:Ljava/lang/String;
...
.method static synthetic access$1400(Lcom/android/server/WifiService;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 118
    invoke-direct {p0, p1}, Lcom/android/server/WifiService;->persistWifiState(I)V
...
.method private checkAndSetNotification()V
    ...
    iget v6, p0, Lcom/android/server/WifiService;->mEthernetHwState:I
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v4, p1, p2, p3}, Lcom/android/internal/util/StateMachine;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public getConnectedDevList()Ljava/util/List;
    ...
    const-string v12, "Exception in getConnectedDevList: "
...
.method public getRange()Ljava/lang/String;
    ...
    const-string v7, "Exception in getRange: "
...
.method public isDualBandSupported()Z
    ...
    const-string v4, "wifi_dual_band_support"
    ...
    const-string v5, "System setting dualBandSupport = "
    ...
    .line 1332
    .end local v0           #dualBandSupport:I
    :goto_0
    return v2

    .line 1325
    .restart local v0       #dualBandSupport:I
    :cond_0
    const/4 v2, 0x0
    ...
    .line 1328
    .local v1, sNFE:Lcom/motorola/android/provider/MotorolaSettings$SettingNotFoundException;
    const-string v2, "WifiService"

    const-string v3, "System setting dualBandSupport not defined. Checking deeper."
...
.method public manageSta(Ljava/util/List;Z)V
    ...
    const-string v5, "Exception in manageSta: "
...
.method public setAutoChannel()V
    ...
    .line 738
    .local v3, nwService:Landroid/os/INetworkManagementService;
    sget-object v4, Lcom/android/server/WifiService;->mSoftapIface:Ljava/lang/String;

    invoke-interface {v3, v4}, Landroid/os/INetworkManagementService;->setAutoChannel(Ljava/lang/String;)I

    move-result v2

    .line 739
    .local v2, hotspotCurrBand:I
    iget-object v4, p0, Lcom/android/server/WifiService;->mWifiStateMachine:Landroid/net/wifi/WifiStateMachine;

    invoke-virtual {v4, v2}, Landroid/net/wifi/WifiStateMachine;->setHotspotCurrBand(I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 743
    .end local v0           #b:Landroid/os/IBinder;
    .end local v2           #hotspotCurrBand:I
    .end local v3           #nwService:Landroid/os/INetworkManagementService;
    :goto_0
    return-void
...
.method public setWifiTxPower(I)Z
    ...
    const-string v6, "Exception is setWifiTxPower: "
...
.method public updateEthernetHwState(I)V
    ...
    .line 819
    iget v2, p0, Lcom/android/server/WifiService;->mEthernetHwState:I
    ...
    .line 827
    invoke-virtual {p0, v4}, Lcom/android/server/WifiService;->disableNetwork(I)Z
    ...
    const-string v3, "USB Ethernet is disconnected, enable all Wifi networks and reconnect"

    invoke-static {v2, v3}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 831
    invoke-virtual {p0, v4, v1}, Lcom/android/server/WifiService;->enableNetwork(IZ)Z

    .line 834
    iget-object v2, p0, Lcom/android/server/WifiService;->mWifiStateMachine:Landroid/net/wifi/WifiStateMachine;

    invoke-virtual {v2}, Landroid/net/wifi/WifiStateMachine;->isAutonomousModeEnabled()Z
    ...
    :cond_3
    invoke-virtual {p0, v1}, Lcom/android/server/WifiService;->startScan(Z)V
