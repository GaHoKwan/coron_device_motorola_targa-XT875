...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    .line 580
    new-instance v5, Lcom/motorola/webtop/WebtopManager;

    iget-object v8, p0, Lcom/android/server/InputMethodManagerService;->mContext:Landroid/content/Context;

    invoke-direct {v5, v8}, Lcom/motorola/webtop/WebtopManager;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/android/server/InputMethodManagerService;->mWebtopManager:Lcom/motorola/webtop/WebtopManager;
...
.method private getMostApplicableDefaultIMELocked()Landroid/view/inputmethod/InputMethodInfo;
    ...
    .line 2216
    .local v4, preferredIME:Ljava/lang/String;
    ...
    .line 2238
    .end local v4           #preferredIME:Ljava/lang/String;
    :goto_0
    return-object v5

    .line 2222
    .restart local v4       #preferredIME:Ljava/lang/String;
    :cond_0
    invoke-interface {v0}, Ljava/util/List;->size()I
...
.method buildInputMethodListLocked(Ljava/util/ArrayList;Ljava/util/HashMap;)V
    ...
    .line 2264
    .local v11, disabledSysImes:Ljava/lang/String;
    if-nez v11, :cond_0
    ...
    const-string v25, "android.view.InputMethod"
    ...
    .line 2270
    .local v22, services:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    move-object/from16 v0, p0
    ...
    .line 2272
    .local v10, defaultInputMethodId:Ljava/lang/String;
    if-nez v10, :cond_1
    ...
    .line 2275
    .local v20, preferredIME:Ljava/lang/String;
    ...
    .line 2282
    .end local v20           #preferredIME:Ljava/lang/String;
    :cond_1
    move-object/from16 v0, p0
    ...
    #calls: Lcom/android/server/InputMethodManagerService$InputMethodSettings;->getEnabledInputMethodsStr()Ljava/lang/String;
    invoke-static/range {v24 .. v24}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->access$900(Lcom/android/server/InputMethodManagerService$InputMethodSettings;)Ljava/lang/String;

    move-result-object v13

    .line 2283
    .local v13, enabledInputMethodsStr:Ljava/lang/String;
    const/16 v24, 0x0
    ...
    .line 2285
    .local v17, needAdd:Ljava/lang/Boolean;
    move-object/from16 v0, p0
    ...
    const-string v26, "Skipping input method "
    ...
    const-string v26, ": it does not require the permission "

    invoke-virtual/range {v25 .. v26}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v25

    const-string v26, "android.permission.BIND_INPUT_METHOD"
    ...
    .end local v10           #defaultInputMethodId:Ljava/lang/String;
    .end local v11           #disabledSysImes:Ljava/lang/String;
    .end local v13           #enabledInputMethodsStr:Ljava/lang/String;
    .end local v14           #haveHardKeyboard:Z
    .end local v15           #i:I
    .end local v17           #needAdd:Ljava/lang/Boolean;
    .end local v21           #ri:Landroid/content/pm/ResolveInfo;
    .end local v22           #services:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    ...
    .restart local v10       #defaultInputMethodId:Ljava/lang/String;
    .restart local v11       #disabledSysImes:Ljava/lang/String;
    .restart local v13       #enabledInputMethodsStr:Ljava/lang/String;
    .restart local v14       #haveHardKeyboard:Z
    .restart local v15       #i:I
    .restart local v17       #needAdd:Ljava/lang/Boolean;
    .restart local v21       #ri:Landroid/content/pm/ResolveInfo;
    .restart local v22       #services:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .restart local v23       #si:Landroid/content/pm/ServiceInfo;
    :cond_4
    :try_start_0
    new-instance v18, Landroid/view/inputmethod/InputMethodInfo;
    ...
    .line 2303
    .local v18, p:Landroid/view/inputmethod/InputMethodInfo;
    ...
    .line 2310
    const-string v24, "com.google.android.googlequicksearchbox/com.google.android.voicesearch.ime.VoiceInputMethodService"
    ...
    const-string v24, "com.google.android.voicesearch/.ime.VoiceInputMethodService"
    ...
    invoke-static/range {v26 .. v26}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->access$1100(Lcom/android/server/InputMethodManagerService$InputMethodSettings;)Ljava/util/List;

    move-result-object v26

    const-string v27, "com.google.android.voicesearch/.ime.VoiceInputMethodService"

    invoke-virtual/range {v24 .. v27}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->buildAndPutEnabledInputMethodsStrRemovingIdLocked(Ljava/lang/StringBuilder;Ljava/util/List;Ljava/lang/String;)Z
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/server/InputMethodManagerService;->isSystemIme(Landroid/view/inputmethod/InputMethodInfo;)Z
    ...
    .end local v18           #p:Landroid/view/inputmethod/InputMethodInfo;
    :catch_0
    move-exception v12
    ...
    const-string v26, "Unable to load input method "
    ...
    .restart local v18       #p:Landroid/view/inputmethod/InputMethodInfo;
    :cond_9
    :try_start_1
    const-string v24, "com.android.inputmethod.latin/.LatinIME"
    ...
    const-string v24, "com.motorola.inputmethod.latinime/.LatinIME"
    ...
    const-string v27, "com.motorola.inputmethod.latinime/.LatinIME"
    ...
    const-string v25, "Default IME is uninstalled. Choose new default IME."
...
.method public setImeWindowStatus(Landroid/os/IBinder;II)V
    ...
    iget-object v12, v0, Lcom/android/server/InputMethodManagerService;->mWebtopManager:Lcom/motorola/webtop/WebtopManager;
...
.method setInputMethodLocked(Ljava/lang/String;I)V
    ...
    const-string v9, "com.google.android.googlequicksearchbox/com.google.android.voicesearch.ime.VoiceInputMethodService"
    ...
    const-string v11, "Illegal subtype state: old subtype = "
    ...
    const-string v10, "Failed to call changeInputMethodSubtype"
    ...
    const-string v9, "android.intent.action.INPUT_METHOD_CHANGED"
    ...
    .line 1511
    const-string v9, "input_method_id"
