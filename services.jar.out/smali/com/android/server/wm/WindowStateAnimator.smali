...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/wm/WindowStateAnimator;->DEBUG_6PA_KPI:Z
    ...
    sput-boolean v0, Lcom/android/server/wm/WindowStateAnimator;->DEBUG_6PA_TOP:Z
...
.method performShowLocked()Z
    ...
    .line 1357
    sget-boolean v3, Lcom/android/server/wm/WindowStateAnimator;->DEBUG_6PA_KPI:Z

    if-eqz v3, :cond_2

    .line 1358
    const-string v3, "KPI-6PA-WMS-6"
    ...
    const-string v5, " WindowState.performShowLocked() sends empty message FINISHED_STARTING"
...
.method stepAnimationLocked(J)Z
    ...
    const-string v5, " Start mAnimation: "
    ...
    iget v3, v3, Lcom/android/server/wm/WindowManagerService;->mAppDisplayWidth:I
    ...
    iget v3, v3, Lcom/android/server/wm/WindowManagerService;->mAppDisplayHeight:I
    ...
    const-string v5, " Finish mAnimation: "
    ...
    .line 281
    :cond_3
    sget-boolean v3, Lcom/android/server/wm/WindowStateAnimator;->DEBUG_6PA_TOP:Z

    if-eqz v3, :cond_4

    .line 282
    const-string v3, "startActivityMayWait"

    invoke-static {v3}, Lcom/motorola/kpi/Kpi6paTop;->get(Ljava/lang/String;)Lcom/motorola/kpi/Kpi6paTop;
    ...
    .line 284
    invoke-virtual {v0}, Lcom/motorola/kpi/Kpi6paTop;->append()V

    .line 285
    invoke-virtual {v0}, Lcom/motorola/kpi/Kpi6paTop;->print()V

    .line 291
    .end local v0           #kpi6paTop:Lcom/motorola/kpi/Kpi6paTop;
    :cond_4
    ...
    iget v3, v1, Lcom/android/server/wm/WindowAnimator;->mPendingLayoutChanges:I

    or-int/lit8 v3, v3, 0x8

    iput v3, v1, Lcom/android/server/wm/WindowAnimator;->mPendingLayoutChanges:I
    ...
    iget v4, v4, Lcom/android/server/wm/WindowAnimator;->mPendingLayoutChanges:I

    invoke-virtual {v1, v3, v4}, Lcom/android/server/wm/WindowManagerService;->debugLayoutRepeats(Ljava/lang/String;I)V
