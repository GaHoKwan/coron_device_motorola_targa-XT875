...
.field private static final DEBUG_6PA_TOP:Z = false
...
.method static constructor <clinit>()V
    ...
    .line 146
    const-string v0, "debug.6pa.top"

    invoke-static {v0, v2}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lcom/android/server/am/ActivityStack;->DEBUG_6PA_TOP:Z
...
.method final ensureActivityConfigurationLocked(Lcom/android/server/am/ActivityRecord;I)Z
    ...
    invoke-virtual {v5, p1}, Lcom/android/server/am/ActivityManagerService;->handleActivityWaitingToFinish(Lcom/android/server/am/ActivityRecord;)Z
    ...
    .line 4652
    invoke-virtual {p1}, Lcom/android/server/am/ActivityRecord;->updateFullscreen()V
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/am/ActivityManagerService;->handleActivityWaitingToFinish(Lcom/android/server/am/ActivityRecord;)Z
    ...
    .line 681
    .local v17, ci:Landroid/content/res/CompatibilityInfo;
    move-object/from16 v0, p1
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/content/res/CompatibilityInfo;->needsWebtopCompat()Z
    ...
    .line 682
    :cond_2
    invoke-virtual/range {v17 .. v17}, Landroid/content/res/CompatibilityInfo;->supportsScreen()Z
    ...
    .line 694
    .end local v17           #ci:Landroid/content/res/CompatibilityInfo;
    :cond_3
    const/4 v2, 0x0
...
.method resolveActivity(Landroid/content/Intent;Ljava/lang/String;ILjava/lang/String;Landroid/os/ParcelFileDescriptor;I)Landroid/content/pm/ActivityInfo;
    ...
    iget-object v1, v8, Landroid/content/pm/PackageItemInfo;->metaData:Landroid/os/Bundle;
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;ILandroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILjava/lang/String;Landroid/os/ParcelFileDescriptor;Landroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;Landroid/os/Bundle;I)I
    ...
    .line 3178
    :cond_0
    sget-boolean v2, Lcom/android/server/am/ActivityStack;->DEBUG_6PA_TOP:Z

    if-eqz v2, :cond_2

    .line 3179
    const-string v2, "startActivityMayWait"

    invoke-static {v2}, Lcom/motorola/kpi/Kpi6paTop;->get(Ljava/lang/String;)Lcom/motorola/kpi/Kpi6paTop;

    move-result-object v26

    .line 3180
    .local v26, kpi6paTop:Lcom/motorola/kpi/Kpi6paTop;
    if-nez v26, :cond_1

    .line 3181
    const-string v2, "startActivityMayWait"

    invoke-static {v2}, Lcom/motorola/kpi/Kpi6paTop;->make(Ljava/lang/String;)Lcom/motorola/kpi/Kpi6paTop;
    ...
    invoke-virtual {v0, v2}, Lcom/motorola/kpi/Kpi6paTop;->start(Z)V

    .line 3187
    .end local v26           #kpi6paTop:Lcom/motorola/kpi/Kpi6paTop;
    :cond_2
    ...
    iget-object v4, v12, Landroid/content/pm/ComponentInfo;->processName:Ljava/lang/String;
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;IZLandroid/os/Bundle;)I
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/am/ActivityManagerService;->handleActivityWaitingToFinish(Lcom/android/server/am/ActivityRecord;)Z
