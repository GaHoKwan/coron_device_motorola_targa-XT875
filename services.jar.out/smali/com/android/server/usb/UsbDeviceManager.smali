...
.field private static final CONNECTED_ACCY_PATH:Ljava/lang/String; = "/sys/class/power_supply/usb/model_name"
...
.field private static final MSG_DEVICE_UNLOCKED:I = 0x6

.field private static final MSG_ENABLE_ADB:I = 0x1

.field private static final MSG_MEDIA_MOUNTED:I = 0x5
...
.method static synthetic access$300(Lcom/android/server/usb/UsbDeviceManager;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private sendUsblanIntent(I)V
    ...
    .prologue
    .line 352
    iget v3, p0, Lcom/android/server/usb/UsbDeviceManager;->mUsbnetEnabled:I
    ...
    .line 354
    .local v2, usblanIntent:Landroid/content/Intent;
    const/4 v3, 0x1
    ...
    const-string v4, "/sys/class/power_supply/usb/model_name"
    ...
    .end local v2           #usblanIntent:Landroid/content/Intent;
    :cond_0
    :goto_0
    return-void
    ...
    .restart local v2       #usblanIntent:Landroid/content/Intent;
    :cond_1
    const-string v3, "com.motorola.intent.action.USBLANUP"
    ...
    const-string v4, "failed to read /sys/class/power_supply/usb/model_name"
    ...
    :cond_2
    const-string v3, "com.motorola.intent.action.USBLANDOWN"
